...
{ 
	...
	public static void dealing(int c1, int c2) 
	{
		...
		/* System.out.println("Pair:- " + players[0].cards[0]+","+players[0].cards[1]);
		System.out.println("Pair:- " + players[1].cards[0]+","+players[1].cards[1]);
		System.out.println("Pair:- " + players[2].cards[0]+","+players[2].cards[1]);
		System.out.println("Pair:- " + players[3].cards[0]+","+players[3].cards[1]);
		System.out.println("Pair:- " + players[4].cards[0]+","+players[4].cards[1]);
	...
	{	
		...
		for(int j=0;j<pairs[0].length;j++){
			...
			for(int k=0;k<50000;k++)
			{
				...
				//System.out.println("Player wins " + pairs[0][j]+","+pairs[1][j]);
				}
			}
